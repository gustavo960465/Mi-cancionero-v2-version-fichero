 $(miRepertorio2());
                ...
                function miRepertorio2(consulta){
                ...
                $.ajax({
                        ...
                        .done(function(respuesta){
                            ...
                            for(var i in canciones.cancion){
                                ...
                                if (canciones.cancion[i].miRepertorio_2 == 1) {
                                html+=`
                                            ...
                                            <div id="musica${canciones.cancion[i].id_cancion}" class="programaMusical">
                                                <div class="contenedorMiProgramaMusical">
                                                    <div class="miProgramaMusicalNumero">
                                                        ...
                                                        if (canciones.cancion[i].numeroMiRepertorio_2 == 0)
                                                            { html+=`value="#)"`}
                                                        else if (canciones.cancion[i].numeroMiRepertorio_2 >= 1)
                                                            { html+=`value="${canciones.cancion[i].numeroMiRepertorio_2})"`}
                                                        html+=`Required value="">
                                                    </div>
                                                    <div class="controlAncla">
                                                        <a href="formularioMiRepertorio2.php?id=${canciones.cancion[i].id_cancion}" class="miProgramaTitulo" id="miProgramaMusicalTitulo"
                                                    ...
                                                    <div class="miProgramaQuitarMusica">
                                                        <input type="submit" id="miProgramaMusicalQuitarMusica_2" class="miProgramaBotonQuitarMusica" data-id="${canciones.cancion[i].id_cancion}"
