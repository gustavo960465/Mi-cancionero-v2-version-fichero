 $(js_Json_Mi_repertorio_2());

        var queryString = window.location.search;
        var urlParams = new URLSearchParams(queryString);
        var valor = urlParams.get('id');

                function js_Json_Mi_repertorio_2(consulta){
                        ...
                        .done(function(respuesta){
                            ...
                            for(var i in canciones.cancion){
                                ...
                                html+=`
                                        ...
                                        <input type="text" id="formularioEditarBorrarNumero" name="formularioEditarBorrarNumero2"`
                                ...
                                $('#js_Json_Mi_repertorio_2').html(html);
                            }
                        })
                        return false;
                }
